<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="AngularTests.Index" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" data-ng-app="<%= (IsEndToEndTest) ? "TestAppE2E" : "TestApp" %>">
    ...
    <head runat="server">
        <title>AngularTests</title>
        <link href="Scripts/ThirdParty/Bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" />
        <link href="Styles/AngularTests.css" rel="stylesheet" type="text/css" />
